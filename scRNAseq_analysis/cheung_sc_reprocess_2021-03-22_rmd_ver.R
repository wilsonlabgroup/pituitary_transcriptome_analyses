...
#'    toc_float: true
#' ---
#' This script reprocesses 10X single-cell RNA-seq data from Cheung et al. 2018 (GSE120410) using Seurat v3.
...
#+ save_seurat, warning = F, message = F
...
#+ plot_other_markers_violin, message = F, warning = F, fig.cap = "Violin plot of other pituitary gene marker expression.", fig.width = 13, fig.height = 6
...
#' A factor of 1000 is used to ensure all the counts are integers (as required for CIBERSORT input).
