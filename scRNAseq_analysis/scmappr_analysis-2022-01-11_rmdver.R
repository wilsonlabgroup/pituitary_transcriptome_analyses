...
#+ compare_deconvolution, warning = F, message = F, fig.width = 8, fig.height = 6, fig.cap = "Comparison of estimated cell proportions from different deconvolution methods."
...
#+ deconrnaseq_plot, warning = F, message = F, fig.width = 14, fig.height = 7, fig.cap = "DeconRNASeq estimated cell proportions."
print(all_decon_plots[[1]])

#+ dcq_plot, warning = F, message = F, fig.width = 14, fig.height = 7, fig.cap = "DCQ estimated cell proportions."
print(all_decon_plots[[2]])

#+ WGCNA_plot, warning = F, message = F, fig.width = 14, fig.height = 7, fig.cap = "WGCNA estimated cell proportions."
...
#+ setup_scmappr, warning = F, message = F
# Run scMappR ####
...
#+ run_scmappr, warning = F, message = F
...
#+ process_cwfc, warning = F, message = F
...
#+ setscmappr_20220111_dir, message = F
knitr::opts_knit$set(root.dir = 'output_files/scmappr_20220111/')

#+ cwfc_plots_12, message = F, fig.width = 10, fig.cap = "Heatmap of gene-normalized cwFC for hormone-producing cell-type-specific sex-biased genes at PD12."
...
#+ cwfc_plots_22, message = F, fig.width = 10, fig.cap = "Heatmap of gene-normalized cwFC for hormone-producing cell-type-specific sex-biased genes at PD22."
...
#+ cwfc_plots_27, message = F, fig.width = 10, fig.cap = "Heatmap of gene-normalized cwFC for hormone-producing cell-type-specific sex-biased genes at PD27."
...
#+ cwfc_plots_32, message = F, fig.width = 10, fig.cap = "Heatmap of gene-normalized cwFC for hormone-producing cell-type-specific sex-biased genes at PD32."
...
#+ cwfc_plots_37, message = F, fig.width = 10, fig.cap = "Heatmap of gene-normalized cwFC for hormone-producing cell-type-specific sex-biased genes at PD37."
...
#+ cwfc_heatmap_combined, message = F, fig.width = 20
