...
#' * 2022/03/05: Trying scTransform normalization
...
#+ sctransform, warning = F, message = F
...
# Gh = somatotrope (0,2,5)
# Pou1f1 = Pou1f1 expressing (1)
# Prl = lactotrope (1)
# Pomc, Crhr1 = corticotrope (3)
# Lhb, Fshb = gonadotrope (4)
# Sox2, Rbpms = stem-cells (6)
# Emcn, Meis2, Plvap = Endothelial (7)
# Top2a, Mki67 = Proliferating (8)
...
# man_mean_mat <- 2^man_mean_mat
# man_mean_mat <- round(man_mean_mat, 2)
...
write.table(man_mean_mat, "output_files/seurat_v4_Cheungpit_sctransform_scaledata_manual_cluster_MEAN_gene_signature_matrix_2022-03-05.txt",
